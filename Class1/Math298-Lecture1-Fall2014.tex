\documentclass[mathserif,handout]{beamer} % Math 298 Fall 2014 Lecture 1
...
\mode<presentation>
{
  ...
  % Note: this next command makes nice slides, but Adobe doesn't like it (you sometimes get blank pages)
...
{\small The Landscape of Parallel Computing View from Berkeley, \\
...
\pgfputat{\pgfxy(1.0,-4.25)}{\pgfbox[left,base]{\pgfimage[width=0.85\textwidth]{Lect1-fig1.png}}}
