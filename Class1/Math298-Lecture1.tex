...
Please note that we will not be able to go into any one subject in much depth.
\end{block}
} % end frame
...
\item It is your responsibility to be be familiar with all of them
...
How many terms in the series should we use?
\end{block}
} % end frame
...
\begin{frame}[allowframebreaks]
 ...
 \newblock Computing Surveys,  ACM, March 1991.
 \beamertemplatearticlebibitems
 \bibitem{Ba05}
 D.H.~Bailey.
